...
function criaCardCarrinho(carrinho) {
    ...
    carrinho.forEach((elemento, index) => {
        saida = `   <div class="border col-12 d-flex p-2 mt-1" id="carrinho-${elemento.id}">
                      <div class="col-5 mt-1 d-flex">
                          <h6>N° Nota: <label id="numero">${elemento.id}</label></h6>
                      </div>
                      <div class="col-5 mt-1 d-flex">
                          <h6>Valor: <label id="valor">${elemento.valor}</label></h6>
                      </div>
                       <div class="col-5 mt-1 d-flex hidden">
                          <h6>Valor: <label id="datavencimento">${elemento.datavencimento}</label></h6>
                      </div>                      
